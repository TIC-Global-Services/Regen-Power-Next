...
}: VideoHotspotExperienceProps) {
  {
    ...
    return (
      <div className="relative h-screen w-full overflow-hidden bg-black">
        ...
        {ready && (
          <div
            className={`absolute bottom-16 md:bottom-24 left-0 w-full z-10 px-[5%] md:px-[3%] flex flex-col md:flex-row md:items-end justify-between gap-8 pointer-events-none transition-all duration-700 ease-in-out ${showText
