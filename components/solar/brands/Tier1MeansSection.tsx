  ...
  return (
    <section className="bg-white border-t border-gray-50 min-h-screen flex items-stretch">
      <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch w-full min-h-screen">
        ...
        <div
          className={`flex flex-col py-5 lg:py-24 px-5 md:px-[5%] ${isImageLeft ? "lg:pl-12 lg:pr-20" : "lg:pl-20 lg:pr-12"} text-left h-full lg:h-screen lg:min-h-screen justify-between`}
        >
          <div>
            {/* <SectionHeader
