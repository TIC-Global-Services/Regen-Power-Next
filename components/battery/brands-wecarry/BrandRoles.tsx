      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <p className="text-sm md:text-base text-black/80 font-normal leading-[1.2] mb-6">
              {data.description}
            </p>
            ...
            <div className="mb-8">
              ...
              <p className="text-sm md:text-base text-black/80 font-normal leading-[1.2]">
            ...
            <div className="bg-[#EEF6EB] border-l-4 border-[#63B846] rounded-r-2xl p-6">
              <p className="text-sm md:text-base text-[#63B846] font-semibold leading-[1.2]">
                {data.highlightText}
              </p>
            </div>
          </div>
