...
const QuickWay: React.FC<{ data: QuickWayData }> = ({ data }) => {
  ...
  return (
    <section className="bg-white border-t border-gray-50 w-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch w-full">
        ...
        <div className="flex flex-col justify-between py-4 lg:py-20 max-w-2xl px-5 lg:pl-[5%] lg:pr-0 text-left">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-base md:text-xl tracking-tight leading-[1.2] font-light mb-8 lg:mb-14">
              {data.subtitle}
            </p>
          </div>
          ...
          <div className="max-w-xl mt-8 lg:mt-12">
            ...
            <ul className="space-y-1 list-none">
              {data.recommendations.map((item, idx) => (
                <li key={idx} className="text-base md:text-xl leading-[1.2] flex items-start">
