export const hero =
  "populate[sections][on][battery-brands.hero][populate]=backgroundImage";

export const brandLongTermBet =
  "populate[sections][on][battery-brands.brand-long-term-bet][populate][cards][populate][image]=true";
