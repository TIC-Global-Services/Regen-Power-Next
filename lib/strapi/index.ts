...
export type { FooterResponse, NavbarResponse } from "./fetchers";

export { populate } from "./populate/index";
export { solar, brands, deals, shared, rebates, batteryRebates, batteryProduct, batteryStorage, smartHomeBattery, batteryBrands, evCharging, home, faq, commercial, research, reviews, promotion, about, footer, navbar, caseStudy } from "./populate/fragments";
