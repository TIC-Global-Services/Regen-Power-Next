            ...
            <tr className="h-[70px] lg:h-[100px]">
              ...
              {columns.map((col, idx) => {
                ...
                return (
                  <th
                    key={idx}
                    className={`bg-[#EEF6EB]/60 p-2 text-black font-normal text-sm lg:text-lg tracking-tight border-b border-black ${
                      isLastCol ? "" : "border-r"
          ...
          <tbody>
            {rows.map((row, rIdx) => {
              ...
              return (
                ...
                >
                  <td
                    className={`bg-[#A0CF44] text-black font-normal p-4 text-base lg:text-lg border-r border-black ${
                      isLastRow ? "" : "border-b"
                    }`}
                  >
                    {row.label}
                  ...
                  {columns.map((col, idx) => {
                    ...
                    return (
                      <td
                        key={idx}
                        className={`bg-[#EEF6EB]/30 p-0 text-black font-normal text-xs lg:text-2xl border-black ${
                          isLastRow ? "" : "border-b"
                        } ${isLastCol ? "" : "border-r"}`}
                      >
                        {value}
