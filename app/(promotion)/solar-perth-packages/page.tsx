import { getPromotionPageBySlug } from '@/lib/strapi/fetchers';
...
export default async function Page() {
  const res = await getPromotionPageBySlug('solar-perth-packages');
  ...
  return <CombinedPromoPage promotion={promotion} hubspotFormId={res.data.hubspotFormId} />;
}
